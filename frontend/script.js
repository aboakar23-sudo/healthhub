    ...
    try {
        ...
        if (!res.ok) {
            ...
            if (saved) {
                ...
                if (d.address) document.getElementById('doc-address').value = d.address || '';
                if (d.university) document.getElementById('doc-university').value = d.university || '';
                if (d.graduation_year) document.getElementById('doc-grad-year').value = d.graduation_year || '';
                if (d.experience_years) document.getElementById('doc-experience').value = d.experience_years || '';
                if (d.certificates) document.getElementById('doc-certificates').value = d.certificates || '';
                if (d.about) document.getElementById('doc-about').value = d.about || '';
            }
            return;
        }
        const data = await res.json();
        if (data.address) document.getElementById('doc-address').value = data.address || '';
        if (data.university) document.getElementById('doc-university').value = data.university || '';
        if (data.graduation_year) document.getElementById('doc-grad-year').value = data.graduation_year || '';
        if (data.experience_years) document.getElementById('doc-experience').value = data.experience_years || '';
        if (data.certificates) document.getElementById('doc-certificates').value = data.certificates || '';
        if (data.about) document.getElementById('doc-about').value = data.about || '';
